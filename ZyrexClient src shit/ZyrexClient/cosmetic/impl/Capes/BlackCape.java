...
/*    */ 
/*    */ 
/*    */ public class BlackCape
/*    */   implements LayerRenderer
/*    */ {
/*    */   private final RenderPlayer playerRenderer;
/*    */   private static final String __OBFID = "CL_00002425";
/* 31 */   public static AnimatedResourceLocation ar = new AnimatedResourceLocation("zyrexcapeblack.png", 6, 20);
/*    */   
/*    */   public BlackCape(RenderPlayer renderPlayer) {
...
/*    */       
/* 41 */       Minecraft.getMinecraft(); if (Client.BlackCape && entitylivingbaseIn == Minecraft.thePlayer) {
/* 42 */         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
/* 43 */         Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("zyrexcapeblack.png"));
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\cosmetic\impl\Capes\BlackCape.class
