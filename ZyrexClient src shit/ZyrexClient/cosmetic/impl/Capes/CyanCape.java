...
/*    */ 
/*    */ 
/*    */ public class CyanCape
/*    */   implements LayerRenderer
/*    */ {
/*    */   private final RenderPlayer playerRenderer;
/*    */   private static final String __OBFID = "CL_00002425";
/* 31 */   public static AnimatedResourceLocation ar = new AnimatedResourceLocation("zyrexcapecyan.png", 6, 20);
/*    */   
/*    */   public CyanCape(RenderPlayer renderPlayer) {
...
/*    */       
/* 41 */       Minecraft.getMinecraft(); if (Client.CyanCape && entitylivingbaseIn == Minecraft.thePlayer) {
/* 42 */         GlStateManager.color(1.0F, 1.0F, 1.0F, 1.0F);
/* 43 */         Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("zyrexcapecyan.png"));
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\cosmetic\impl\Capes\CyanCape.class
