...
/* 15 */     Gui.drawRect(x, y + cornerRadius, x + cornerRadius, y + height - cornerRadius, color.getRGB());
/* 16 */     Gui.drawRect(x + cornerRadius, y, x + width - cornerRadius, y + height, color.getRGB());
/* 17 */     Gui.drawRect(x + width - cornerRadius, y + cornerRadius, x + width, y + height - cornerRadius, color.getRGB());
/*    */     
/* 19 */     drawArc(x + cornerRadius, y + cornerRadius, cornerRadius, 0, 90, color);
/* 20 */     drawArc(x + width - cornerRadius, y + cornerRadius, cornerRadius, 270, 360, color);
/* 21 */     drawArc(x + width - cornerRadius, y + height - cornerRadius, cornerRadius, 180, 270, color);
/* 22 */     drawArc(x + cornerRadius, y + height - cornerRadius, cornerRadius, 90, 180, color);
/*    */   }
/*    */ 
/*    */   
...
/* 36 */     worldRenderer.pos(x, y, 0.0D).endVertex();
/*    */     
...
/* 40 */       worldRenderer.pos(x + Math.sin(angle) * radius, y + Math.cos(angle) * radius, 0.0D).endVertex();
/*    */     } 
/*    */     
