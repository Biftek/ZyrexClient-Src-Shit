...
/*     */ 
/*     */     
/*  81 */     buttonList.add(new SettingsButtonToggle(1, width / 2 - 29, height / 2 - 45, 60, 15, "CompactChat"));
/*  82 */     buttonList.add(new SettingsButtonToggleBG(2, width / 2 - 29, height / 2, 60, 15, "ChatBackground"));
...
/*     */     
/* 110 */     FontUtil.renderCenteredString("Custom Chat Settings", width / 2 + 1, height / 2 - 110, (new Color(255, 255, 255)).getRGB(), 1.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 115 */     FontUtil.renderCenteredString("Compact Chat", width / 2 + 1, height / 2 - 67, (new Color(255, 255, 255)).getRGB(), 1.0F);
/* 116 */     FontUtil.renderCenteredString("[ Stacks the spam messages]", width / 2 + 1, height / 2 - 55, (new Color(155, 155, 155)).getRGB(), 0.6F);
/*     */ 
/*     */     
/* 119 */     FontUtil.renderCenteredString("Background", width / 2 - 1, height / 2 - 22, (new Color(255, 255, 255)).getRGB(), 1.0F);
/* 120 */     FontUtil.renderCenteredString("[ Background for the chat ]", width / 2 + 1, height / 2 - 10, (new Color(155, 155, 155)).getRGB(), 0.6F);
/*     */     
...
/*     */     
/* 158 */     if (button.id == 1) {
/* 159 */       SettingsButtonToggle.save("CompactChat", Boolean.valueOf(!SettingsButtonToggle.load("CompactChat").booleanValue()));
/* 160 */       if (ModToggle.loadEnabledFromFile("Mods/ZyrexModCustomChat/ModNoBackground").booleanValue()) {
/* 161 */         Client.CompactChat = !Client.CompactChat;
/* 162 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModCustomChat/ModNoBackground", Boolean.valueOf(Client.CompactChat));
/*     */       } else {
/* 164 */         Client.CompactChat = !Client.CompactChat;
/* 165 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModCustomChat/ModNoBackground", Boolean.valueOf(Client.CompactChat));
/*     */       } 
/*     */     } 
/*     */     
/* 169 */     if (button.id == 2) {
/* 170 */       SettingsButtonToggle.save("ChatBackground", Boolean.valueOf(!SettingsButtonToggle.load("ChatBackground").booleanValue()));
/* 171 */       if (ModToggle.loadEnabledFromFile("Mods/ZyrexModCustomChat/ModNoBackground").booleanValue()) {
/* 172 */         Client.NoBackground = !Client.NoBackground;
/* 173 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModCustomChat/ModNoBackground", Boolean.valueOf(Client.NoBackground));
/*     */       } else {
/* 175 */         Client.NoBackground = !Client.NoBackground;
/* 176 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModCustomChat/ModNoBackground", Boolean.valueOf(Client.NoBackground));
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\ModHuds\ChatSettings.class
