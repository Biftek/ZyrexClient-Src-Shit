...
/*     */ 
/*     */     
/*  81 */     buttonList.add(new SettingsButtonToggle(1, width / 2 - 29, height / 2 - 45, 60, 15, "FPSChroma"));
/*  82 */     buttonList.add(new SettingsButtonToggleBG(2, width / 2 - 29, height / 2, 60, 15, "FPSBackground"));
...
/*     */     
/* 110 */     FontUtil.renderCenteredString("FPS Settings", width / 2 + 1, height / 2 - 110, (new Color(255, 255, 255)).getRGB(), 1.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 115 */     FontUtil.renderCenteredString("Chroma", width / 2 - 1, height / 2 - 67, (new Color(255, 255, 255)).getRGB(), 1.0F);
/* 116 */     FontUtil.renderCenteredString("[ Rainbow FPS counter ]", width / 2 + 1, height / 2 - 55, (new Color(155, 155, 155)).getRGB(), 0.6F);
/*     */ 
/*     */     
...
/*     */     
/* 158 */     if (button.id == 1) {
/* 159 */       SettingsButtonToggle.save("FPSChroma", Boolean.valueOf(!SettingsButtonToggle.load("FPSChroma").booleanValue()));
/* 160 */       if (ModToggle.loadEnabledFromFile("Mods/ZyrexModFPS/isChromaDisabled").booleanValue()) {
/* 161 */         Client.FPSChroma = !Client.FPSChroma;
/* 162 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModFPS/isChromaDisabled", Boolean.valueOf(Client.FPSChroma));
/*     */       } else {
/* 164 */         Client.FPSChroma = !Client.FPSChroma;
/* 165 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModFPS/isChromaDisabled", Boolean.valueOf(Client.FPSChroma));
/*     */       } 
/*     */     } 
/*     */     
/* 169 */     if (button.id == 2) {
/* 170 */       SettingsButtonToggle.save("FPSBackground", Boolean.valueOf(!SettingsButtonToggle.load("FPSBackground").booleanValue()));
/* 171 */       if (ModToggle.loadEnabledFromFile("Mods/ZyrexModFPS/FPSBackground").booleanValue()) {
/* 172 */         Client.FPSBackground = !Client.FPSBackground;
/* 173 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModFPS/FPSBackground", Boolean.valueOf(Client.FPSBackground));
/*     */       } else {
/* 175 */         Client.FPSBackground = !Client.FPSBackground;
/* 176 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModFPS/FPSBackground", Boolean.valueOf(Client.FPSBackground));
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\ModHuds\FPSSettings.class
