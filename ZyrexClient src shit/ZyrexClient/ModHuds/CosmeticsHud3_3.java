...
/*  86 */     buttonList.add(new ButtonMainMenuZ(0, width / 2 - 260, height / 2 + 10, 140, 12, I18n.format("§8Head Wears", new Object[0])));
/*     */     
/*  88 */     buttonList.add(new ButtonCosmetics(1, width / 2 - 95, height / 2 - 60, 208, 20, "Eggs"));
/*  89 */     buttonList.add(new ButtonCosmetics(2, width / 2 - 95, height / 2 - 10, 208, 20, "Rock Pet"));
/*  90 */     buttonList.add(new ButtonCosmetics(3, width / 2 - 95, height / 2 - 35, 208, 20, "Witch Hat"));
/*     */     
...
/*     */     
/* 112 */     RenderPlayerOnScreen.drawEntityOnScreen(sr.getScaledWidth() / 2 + 205, sr.getScaledHeight() / 2 + 90, 80, 380.0F, (EntityLivingBase)Minecraft.thePlayer);
/*     */ 
/*     */     
...
/* 147 */     FontUtil.renderCenteredString("Avaliable Headwears", width / 2 + 8, height / 2 - 107, -1, 1.0F);
/*     */     
...
/* 155 */     if (button.id == 90) {
/* 156 */       mc.displayGuiScreen(new ModHud5_Settings());
/*     */     }
/*     */     
/* 159 */     if (button.id == 50) {
/* 160 */       mc.displayGuiScreen(new ModHud5());
/*     */     }
/*     */     
/* 163 */     if (button.id == 60) {
/* 164 */       mc.displayGuiScreen(new CosmeticsHud3());
/*     */     }
/*     */     
/* 167 */     if (button.id == 70) {
/* 168 */       mc.displayGuiScreen(new CosmeticsHud3_2());
/*     */     }
/*     */     
/* 171 */     if (button.id == 1) {
/* 172 */       ButtonCosmetics.save("Eggs", Boolean.valueOf(!ButtonCosmetics.load("Eggs").booleanValue()));
/* 173 */       if (!ModToggle.loadEnabledFromFile("Cosmetics/HeadWears/EasterEggs").booleanValue()) {
/* 174 */         Client.CosmeticEasterEggs = !Client.CosmeticEasterEggs;
/* 175 */         ModToggle.saveIsEnabledToFile("Cosmetics/HeadWears/EasterEggs", Boolean.valueOf(Client.CosmeticEasterEggs));
/*     */       } else {
/* 177 */         Client.CosmeticEasterEggs = !Client.CosmeticEasterEggs;
/* 178 */         ModToggle.saveIsEnabledToFile("Cosmetics/HeadWears/EasterEggs", Boolean.valueOf(Client.CosmeticEasterEggs));
/*     */       } 
/*     */     } 
/* 181 */     if (button.id == 2) {
/* 182 */       ButtonCosmetics.save("Rock Pet", Boolean.valueOf(!ButtonCosmetics.load("Rock Pet").booleanValue()));
/* 183 */       if (!ModToggle.loadEnabledFromFile("Cosmetics/HeadWears/PetRock").booleanValue()) {
/* 184 */         Client.CosmeticRockPet = !Client.CosmeticRockPet;
/* 185 */         ModToggle.saveIsEnabledToFile("Cosmetics/HeadWears/PetRock", Boolean.valueOf(Client.CosmeticRockPet));
/*     */       } else {
/* 187 */         Client.CosmeticRockPet = !Client.CosmeticRockPet;
/* 188 */         ModToggle.saveIsEnabledToFile("Cosmetics/HeadWears/PetRock", Boolean.valueOf(Client.CosmeticRockPet));
/*     */       } 
/*     */     } 
/* 191 */     if (button.id == 3) {
/* 192 */       ButtonCosmetics.save("Witch Hat", Boolean.valueOf(!ButtonCosmetics.load("Witch Hat").booleanValue()));
/* 193 */       if (!ModToggle.loadEnabledFromFile("Cosmetics/HeadWears/WitchHat").booleanValue()) {
/* 194 */         Client.CosmeticWitchHat = !Client.CosmeticWitchHat;
/* 195 */         ModToggle.saveIsEnabledToFile("Cosmetics/HeadWears/WitchHat", Boolean.valueOf(Client.CosmeticWitchHat));
/*     */       } else {
/* 197 */         Client.CosmeticWitchHat = !Client.CosmeticWitchHat;
/* 198 */         ModToggle.saveIsEnabledToFile("Cosmetics/HeadWears/WitchHat", Boolean.valueOf(Client.CosmeticWitchHat));
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\ModHuds\CosmeticsHud3_3.class
