...
/*     */ 
/*     */     
/*  81 */     buttonList.add(new SettingsButtonToggle(1, width / 2 - 29, height / 2 - 45, 60, 15, "CoordinatesChroma"));
/*  82 */     buttonList.add(new SettingsButtonToggleBG(2, width / 2 - 29, height / 2, 60, 15, "CoordinatesBackground"));
...
/*     */     
/* 110 */     FontUtil.renderCenteredString("Coordinates Settings", width / 2 + 1, height / 2 - 110, (new Color(255, 255, 255)).getRGB(), 1.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 115 */     FontUtil.renderCenteredString("Chroma", width / 2 - 1, height / 2 - 67, (new Color(255, 255, 255)).getRGB(), 1.0F);
/* 116 */     FontUtil.renderCenteredString("[ Rainbow Coordinates ]", width / 2 + 1, height / 2 - 55, (new Color(155, 155, 155)).getRGB(), 0.6F);
/*     */ 
/*     */     
...
/*     */     
/* 158 */     if (button.id == 1) {
/* 159 */       SettingsButtonToggle.save("CoordinatesChroma", Boolean.valueOf(!SettingsButtonToggle.load("CoordinatesChroma").booleanValue()));
/* 160 */       if (ModToggle.loadEnabledFromFile("Mods/ZyrexModCoordinates/isChromaDisabled").booleanValue()) {
/* 161 */         Client.CoordinatesChroma = !Client.CoordinatesChroma;
/* 162 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModCoordinates/isChromaDisabled", Boolean.valueOf(Client.CoordinatesChroma));
/*     */       } else {
/* 164 */         Client.CoordinatesChroma = !Client.CoordinatesChroma;
/* 165 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModCoordinates/isChromaDisabled", Boolean.valueOf(Client.CoordinatesChroma));
/*     */       } 
/*     */     } 
/*     */     
/* 169 */     if (button.id == 2) {
/* 170 */       SettingsButtonToggle.save("CoordinatesBackground", Boolean.valueOf(!SettingsButtonToggle.load("CoordinatesBackground").booleanValue()));
/* 171 */       if (ModToggle.loadEnabledFromFile("Mods/ZyrexModCoordinates/CoordinatesBackground").booleanValue()) {
/* 172 */         Client.CoordinatesBackground = !Client.CoordinatesBackground;
/* 173 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModCoordinates/CoordinatesBackground", Boolean.valueOf(Client.CoordinatesBackground));
/*     */       } else {
/* 175 */         Client.CoordinatesBackground = !Client.CoordinatesBackground;
/* 176 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModCoordinates/CoordinatesBackground", Boolean.valueOf(Client.CoordinatesBackground));
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\ModHuds\CoordinatesSettings.class
