...
/*     */ 
/*     */     
/*  81 */     buttonList.add(new SettingsButtonToggle(1, width / 2 - 29, height / 2 - 45, 60, 15, "ArmorStatusChroma"));
/*  82 */     buttonList.add(new SettingsButtonToggleBG(2, width / 2 - 29, height / 2, 60, 15, "ArmorStatusBackground"));
...
/*     */     
/* 110 */     FontUtil.renderCenteredString("Armor Status Settings", width / 2 + 1, height / 2 - 110, (new Color(255, 255, 255)).getRGB(), 1.0F);
/*     */ 
/*     */ 
/*     */ 
/*     */     
/* 115 */     FontUtil.renderCenteredString("Chroma", width / 2 - 1, height / 2 - 67, (new Color(255, 255, 255)).getRGB(), 1.0F);
/* 116 */     FontUtil.renderCenteredString("[ Rainbow Armor Status]", width / 2 + 1, height / 2 - 55, (new Color(155, 155, 155)).getRGB(), 0.6F);
/*     */ 
/*     */     
...
/*     */     
/* 158 */     if (button.id == 1) {
/* 159 */       SettingsButtonToggle.save("ArmorStatusChroma", Boolean.valueOf(!SettingsButtonToggle.load("ArmorStatusChroma").booleanValue()));
/* 160 */       if (ModToggle.loadEnabledFromFile("Mods/ZyrexModArmorStatus/isChromaDisabled").booleanValue()) {
/* 161 */         Client.ArmorStatusChroma = !Client.ArmorStatusChroma;
/* 162 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModArmorStatus/isChromaDisabled", Boolean.valueOf(Client.ArmorStatusChroma));
/*     */       } else {
/* 164 */         Client.ArmorStatusChroma = !Client.ArmorStatusChroma;
/* 165 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModArmorStatus/isChromaDisabled", Boolean.valueOf(Client.ArmorStatusChroma));
/*     */       } 
/*     */     } 
/*     */     
/* 169 */     if (button.id == 2) {
/* 170 */       SettingsButtonToggle.save("ArmorStatusBackground", Boolean.valueOf(!SettingsButtonToggle.load("ArmorStatusBackground").booleanValue()));
/* 171 */       if (ModToggle.loadEnabledFromFile("Mods/ZyrexModArmorStatus/ArmorStatusBackground").booleanValue()) {
/* 172 */         Client.ArmorStatusBackground = !Client.ArmorStatusBackground;
/* 173 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModArmorStatus/ArmorStatusBackgroundBackground", Boolean.valueOf(Client.ArmorStatusBackground));
/*     */       } else {
/* 175 */         Client.ArmorStatusBackground = !Client.ArmorStatusBackground;
/* 176 */         ModToggle.saveIsEnabledToFile("Mods/ZyrexModArmorStatus/ArmorStatusBackground", Boolean.valueOf(Client.ArmorStatusBackground));
/*     */       } 
/*     */     } 
/*     */   }
/*     */ }
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\ModHuds\ArmorStatusSettings.class
