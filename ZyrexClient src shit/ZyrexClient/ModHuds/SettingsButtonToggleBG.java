...
/*     */ 
/*     */ 
/*     */ public class SettingsButtonToggleBG
/*     */   extends GuiButton
/*     */ {
...
/*     */   
/*     */   public SettingsButtonToggleBG(int buttonId, int x, int y, String s) {
/*  32 */     this(buttonId, x, y, false, s);
/*     */   }
/*     */   
/*     */   public SettingsButtonToggleBG(int buttonId, int x, int y, boolean checked, String s) {
/*  36 */     this(buttonId, x, y, 20, 20, checked, s);
/*     */   }
/*     */   
/*     */   public SettingsButtonToggleBG(int buttonId, int x, int y, int width, int height, String s) {
/*  40 */     this(buttonId, x, y, width, height, false, s);
/*     */   }
/*     */   
/*     */   public SettingsButtonToggleBG(int buttonId, int x, int y, int width, int height, boolean checked, String s) {
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\ModHuds\SettingsButtonToggleBG.class
