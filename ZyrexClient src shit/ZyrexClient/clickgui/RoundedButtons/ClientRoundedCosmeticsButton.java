...
/*     */ 
/*     */ 
/*     */ public class ClientRoundedCosmeticsButton
/*     */   extends GuiButton
/*     */ {
/*     */   private int j6;
/*     */   private int j10;
...
/*     */   int fade2;
/*     */   
/*     */   public ClientRoundedCosmeticsButton(int i, int j, int k, String s) {
/*  30 */     this(i, j, k, 120, k, s);
/*     */   }
/*     */ 
/*     */   
/*     */   public ClientRoundedCosmeticsButton(int i, int j, int k, int l, int i1, String s) {
...
/* 105 */       Minecraft.getMinecraft().getTextureManager().bindTexture(new ResourceLocation("cosmetics_icon.png"));
/* 106 */       Gui.drawModalRectWithCustomSizedTexture(this.xPosition + 3, this.yPosition + 3, 0.0F, 0.0F, 15, 15, 15.0F, 15.0F);
/*     */       
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\clickgui\RoundedButtons\ClientRoundedCosmeticsButton.class
