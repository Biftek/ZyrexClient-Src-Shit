...
/*     */   int fade2;
/*     */   
/*     */   public ButtonMainMenuZ(int i, int j, int k, String s) {
/*  30 */     this(i, j, k, 120, k, s);
/*     */   }
/*     */ 
/*     */   
/*     */   public ButtonMainMenuZ(int i, int j, int k, int l, int i1, String s) {
...
/*  62 */     int j = (new Color(255, 255, 255)).getRGB();
/*  63 */     if (this.hovered) {
/*  64 */       j = 35071;
/*     */     }
...
/*  67 */       int n = 5;
/*     */       
/*  69 */       FontRenderer fr = mc.clientFont;
...
/*     */       
/*  72 */       FontUtil.renderCenteredStringAnimated(this.displayString, (this.xPosition + this.width / 2) + this.speed, (this.yPosition + (this.height - 12) / 2), j, 1.05F);
/*     */     } 
/*     */   }
/*     */ 
/*     */ 
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\clickgui\RoundedButtons\ButtonMainMenuZ.class
