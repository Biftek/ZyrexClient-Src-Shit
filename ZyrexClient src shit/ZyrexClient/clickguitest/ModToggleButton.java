...
/*     */ 
/*     */   
/*     */   public ModToggleButton(int i, int j, int k, String s) {
/*  27 */     this(i, j, k, 120, 20, s);
/*     */   }
/*     */ 
/*     */   
/*     */   public ModToggleButton(int i, int j, int k, int l, int i1, String s) {
...
/*     */       
/*  56 */       drawRoundedRect(this.xPosition - 32, this.yPosition - 81, this.width + 64, this.height + 96, this.height / 2 - 4, new Color(30, 32, 34));
/*  57 */       drawRoundedRect(this.xPosition - 30, this.yPosition - 79, this.width + 60, this.height + 92, this.height / 2 - 4, new Color(24, 26, 28));
/*     */       
/*  59 */       drawRoundedRect(this.xPosition, this.yPosition, this.width, this.height, this.height / 2, new Color(255, 80, 80));
/*  60 */       drawCircle(this.xPosition + 1, this.yPosition + 1, this.height - 2, this.height - 2, this.c);
/*     */       
/*  62 */       FontUtil.renderCenteredString(this.displayString, this.xPosition + 12, this.yPosition - 75, -1, 1.0F);
/*     */     } else {
/*     */       
/*  65 */       drawRoundedRect(this.xPosition - 32, this.yPosition - 81, this.width + 64, this.height + 96, this.height / 2 - 4, new Color(30, 32, 34));
/*  66 */       drawRoundedRect(this.xPosition - 30, this.yPosition - 79, this.width + 60, this.height + 92, this.height / 2 - 4, new Color(24, 26, 28));
/*     */ 
/*     */       
/*  69 */       drawRoundedRect(this.xPosition, this.yPosition, this.width, this.height, this.height / 2, new Color(50, 100, 255));
/*  70 */       drawCircle(this.xPosition + this.width - this.height + 1, this.yPosition + 1, this.height - 2, this.height - 2, this.c);
/*     */       
...
/* Location:              C:\Users\Lenovo\Downloads\ZyrexClientV1 (1).jar!\ZyrexClient\clickguitest\ModToggleButton.class
